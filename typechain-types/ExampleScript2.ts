...
export interface ExampleScript2Interface extends ethers.utils.Interface {
  functions: {
...
export interface ExampleScript2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ExampleScript2Interface;
