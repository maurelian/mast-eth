...
export interface ExampleScript0Interface extends ethers.utils.Interface {
  functions: {
...
export interface ExampleScript0 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ExampleScript0Interface;
